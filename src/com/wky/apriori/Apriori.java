...
public class Apriori {
         ...
         private final static double CONFIDENCE = 0.999; // 置信度阈值
         ...
         static{//初始化交易记录
                   transList.add("亚硝酸盐未检出;大肠菌群优;菌落总数良;");
                   transList.add("亚硝酸盐中;大肠菌群差;菌落总数危险;");
                   transList.add("亚硝酸盐优;大肠菌群良;菌落总数中;");
                   transList.add("酸亿;大肠菌群良;菌落总数中;");
                   transList.add("亚硝酸盐优;大肠菌群良;菌落总数中;");
                   transList.add("加;大肠菌群良;菌落总数中;");
         }
