...
public class ElemPlaceAnalyse {
	public List<DairyBean> getAflatoxinPlaceAnalyse(String place){
	...
	//∏ı
	public List<DairyBean> getCrPlaceAnalyse(String place){
		Connection conn = DBConnection.getConnection();
		PreparedStatement ps = null;
		ResultSet rs = null;
		//String sql = "select dairy.DairyID,dairy.SimpleName,CrRe from dairy where dairy.DetectPlace like '%Õ≠»  –%' and CrRe  REGEXP '[0-9]'";
	...
	//ProteinRe
	public List<DairyBean> getProteinPlaceAnalyse(String place){
		Connection conn = DBConnection.getConnection();
		PreparedStatement ps = null;
		ResultSet rs = null;
		//String sql = "select dairy.DairyID,dairy.SimpleName,CrRe from dairy where dairy.DetectPlace like '%Õ≠»  –%' and CrRe  REGEXP '[0-9]'";
