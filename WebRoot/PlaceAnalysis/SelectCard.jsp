...
<html>
  ...
  <body>
  	 <div id="tabs">
        ...
        <div class="tabs_content" id="main1" style="height:600px">
            
        </div>
        <div class="tabs_content" id="main2" style="height:600px">
            <p>
		                这是选项卡二的内容？<br />
		                这是选项卡二的内容？<br />
		                这是选项卡二的内容？<br />
        ...
        <div class="tabs_content" id="main3" style="height:600px">
            <p>
		                这是选项卡三的内容？<br />
		                这是选项卡三的内容？<br />
		                这是选项卡三的内容？<br />
