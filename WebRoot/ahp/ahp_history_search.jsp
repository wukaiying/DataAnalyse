  ...
  <body>
  	<div class="mainpanel" style="width: 100%;">
  	 <div class="pageheader">
         <h2><i class="fa fa-bug"></i>层次分析历史查询</h2>
                    
     </div>
     <div>
     	<form action="AHPHistorySearchServlet" method="post">
					<div align="center">
						<div>
		...
		<div class="row">
			...
			<table id="mytable" class="display" cellspacing="0" width="100%" align="center">
				...
				<tbody>
					<c:forEach var="entry" items="${listAHP }">
						<tr>
							<td><c:out value="${entry.id}" /></td>
							<td><c:out value="${entry.time}" /></td>
							<td><c:out value="${entry.category}" /></td>
							<td><a href="AHPDetailsServlet?id=${entry.id }">查看详细</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
