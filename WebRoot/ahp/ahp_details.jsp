...
<html>
  ...
  <body>
   <%	
  	String weightBar = (String)request.getAttribute("weightOptionBar");
  	String weightPie = (String)request.getAttribute("weightOptionPie");
  	String productRiskBar = (String)request.getAttribute("productRiskOptionBar");
   %>
